...
export const file_api_v1_instance_service: GenFile = /*@__PURE__*/
  fileDesc("", [file_api_v1_user_service, file_google_api_annotations, file_google_api_client, file_google_api_field_behavior, file_google_api_resource, file_google_protobuf_field_mask]);
...
export type InstanceSetting = Message<"memos.api.v1.InstanceSetting"> & {
  ...
  value: {
    ...
    /**
     * @generated from field: memos.api.v1.InstanceSetting.AISetting ai_setting = 5;
     */
...
/**
 * AI configuration settings for semantic search.
 *
...
export type InstanceSetting_AISetting = Message<"memos.api.v1.InstanceSetting.AISetting"> & {
   ...
   *
   * @generated from field: string openai_base_url = 1;
   */
   ...
   *
   * @generated from field: string openai_embedding_model = 2;
   */
  openaiEmbeddingModel: string;

  /**
   * openai_api_key is write-only plain text API key from frontend.
   * It is encrypted before being persisted by backend.
   *
   * @generated from field: string openai_api_key = 3;
   */
  openaiApiKey: string;

  /**
   * openai_api_key_set indicates if backend already has a stored API key.
   *
   * @generated from field: bool openai_api_key_set = 4;
   */
   ...
   *
   * @generated from field: bool clear_openai_api_key = 5;
   */
   ...
   *
   * @generated from field: int32 openai_embedding_max_retry = 6;
   */
  openaiEmbeddingMaxRetry: number;

  /**
   * openai_embedding_retry_backoff_ms controls retry backoff base in milliseconds.
   * Value <= 0 means using backend default/fallback behavior.
   *
   * @generated from field: int32 openai_embedding_retry_backoff_ms = 7;
   */
  openaiEmbeddingRetryBackoffMs: number;

  /**
   * semantic_embedding_concurrency controls concurrent async embedding refresh jobs.
   * Value <= 0 means using backend default/fallback behavior.
   *
   * @generated from field: int32 semantic_embedding_concurrency = 8;
   */
  semanticEmbeddingConcurrency: number;

  /**
   * openai_embedding_models is the saved model list for quick switching.
   *
   * @generated from field: repeated string openai_embedding_models = 9;
   */
   ...
   *
   * @generated from field: bool semantic_reindex_running = 10;
   */
  semanticReindexRunning: boolean;

  /**
   * semantic_reindex_total is the total memo count for current/last reindex task.
   *
   * @generated from field: int32 semantic_reindex_total = 11;
   */
  semanticReindexTotal: number;

  /**
   * semantic_reindex_processed is the processed memo count for current/last reindex task.
   *
   * @generated from field: int32 semantic_reindex_processed = 12;
   */
  semanticReindexProcessed: number;

  /**
   * semantic_reindex_failed is the failed memo count for current/last reindex task.
   *
   * @generated from field: int32 semantic_reindex_failed = 13;
   */
  semanticReindexFailed: number;

  /**
   * semantic_reindex_started_ts is the unix timestamp in seconds when current/last reindex started.
   *
   * @generated from field: int64 semantic_reindex_started_ts = 14;
   */
  semanticReindexStartedTs: bigint;

  /**
   * semantic_reindex_updated_ts is the unix timestamp in seconds when progress last updated.
   *
   * @generated from field: int64 semantic_reindex_updated_ts = 15;
   */
  semanticReindexUpdatedTs: bigint;

  /**
   * semantic_reindex_model is the model used by current/last reindex task.
   *
   * @generated from field: string semantic_reindex_model = 16;
   */
  semanticReindexModel: string;
   ...
   *
   * @generated from field: bool trigger_semantic_reindex = 17;
   */
  triggerSemanticReindex: boolean;
};
