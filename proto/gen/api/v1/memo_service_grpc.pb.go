...
const (
	...
	MemoService_SearchMemosSemantic_FullMethodName = "/memos.api.v1.MemoService/SearchMemosSemantic"
...
type MemoServiceClient interface {
	...
	SearchMemosSemantic(ctx context.Context, in *SearchMemosSemanticRequest, opts ...grpc.CallOption) (*ListMemosResponse, error)
	// GetMemo gets a memo.
...
func (c *memoServiceClient) SearchMemosSemantic(ctx context.Context, in *SearchMemosSemanticRequest, opts ...grpc.CallOption) (*ListMemosResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListMemosResponse)
	err := c.cc.Invoke(ctx, MemoService_SearchMemosSemantic_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MemoServiceServer interface {
	...
	// SearchMemosSemantic searches memos by semantic similarity.
	SearchMemosSemantic(context.Context, *SearchMemosSemanticRequest) (*ListMemosResponse, error)
	// GetMemo gets a memo.
...
func (UnimplementedMemoServiceServer) SearchMemosSemantic(context.Context, *SearchMemosSemanticRequest) (*ListMemosResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SearchMemosSemantic not implemented")
}
...
func _MemoService_SearchMemosSemantic_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SearchMemosSemanticRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MemoServiceServer).SearchMemosSemantic(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MemoService_SearchMemosSemantic_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MemoServiceServer).SearchMemosSemantic(ctx, req.(*SearchMemosSemanticRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MemoService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SearchMemosSemantic",
			Handler:    _MemoService_SearchMemosSemantic_Handler,
		},
		{
			MethodName: "GetMemo",
